...
import HourglassLogotype from '../styles/img/social-proof/Hourglass/Logotype.svg';
import HourglassMark from '../styles/img/social-proof/Hourglass/Logomark.svg';
...
export const socialProofData = [
        ...
        {
                title: 'Hourglass',
                logotype: HourglassLogotype,
                logomark: HourglassMark,
        },
];
